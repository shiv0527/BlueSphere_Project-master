<template>
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('package')">
        <icon name="printer" class="w-4 h-4 mr-2" :class="isUrl('package') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('package') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">My package</div>
      </inertia-link>
    </div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('leads')">
        <icon name="lead" class="w-4 h-4 mr-2" :class="isUrl('leads') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('leads') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Leads</div>
      </inertia-link>
    </div>

    <!-- <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('')">
        <icon name="payment" class="w-4 h-4 mr-2" :class="isUrl('') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Payment History</div>
      </inertia-link>
    </div> -->
  </div>
</template>
