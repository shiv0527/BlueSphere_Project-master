      ...
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="login">
        <div class="px-10 py-12">
          ...
          <div class="mt-6 text-center">
            <span class="text-sm">New to BlueSphere?</span>
            <inertia-link class="hover:underline text-sm" :href="route('register')">
              Register
            </inertia-link>
          </div>

          <div class="mt-6 text-center">
            <inertia-link class="hover:underline text-sm" :href="route('password.request')">
              Forgot Password?
            </inertia-link>
          </div>
        </div>
